...
/**
 * Composant de contenu de la page de succès (avec searchParams)
 */
function AuthSuccessContent({ searchParams }) {
 ...
 */
export default function AuthSuccessPage({ searchParams }) {
  return (
    <Suspense
      fallback={
    ...
    >
      <AuthSuccessContent searchParams={searchParams} />
    </Suspense>
  );
}
